...
#include "../ProjPOO/startingwindow.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_StartingWindow_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 32, 12)
    ...
    "StartingWindow\0launchLoginForm\0\0"
    "launchSignUp\0"
};
...
void StartingWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->launchLoginForm(); break;
        case 1: _t->launchSignUp(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject StartingWindow::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_StartingWindow.data,
      qt_meta_data_StartingWindow,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_StartingWindow.stringdata))
